/**
 * متغيّرات البيئة اللازمة. مراجع ثابتة عمدًا: Next يستبدل
 * process.env.NEXT_PUBLIC_* نصيًا وقت البناء، والقراءة بمفتاح ديناميكي
 * (process.env[name]) تُرجع undefined في بيئة Edge حتى لو كان مضبوطًا.
 */
